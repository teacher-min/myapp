...
public class MyFileUtils {
  ...
  public String getBlogImageUploadPath() {
    return "/home/ubuntu/blog" + DateTimeFormatter.ofPattern("/yyyy/MM/dd").format(TODAY);
  }
  
  // 블로그 이미지가 저장된 어제 경로를 반환
  public String getBlogImageUploadPathInYesterday() {
    return "/home/ubuntu/blog" + DateTimeFormatter.ofPattern("/yyyy/MM/dd").format(TODAY.minusDays(1));
  }
