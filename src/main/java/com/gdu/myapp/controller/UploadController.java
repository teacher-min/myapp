...
public class UploadController {
  ...
  public String register(MultipartHttpServletRequest multipartRequest
    ...
    redirectAttributes.addFlashAttribute("insertMessage", uploadService.registerUpload(multipartRequest) ? "업로드되었습니다." : "업로드가 실패했습니다.");
  ...
  public String modify(UploadDto upload, RedirectAttributes redirectAttributes) {
    redirectAttributes
      ...
      .addFlashAttribute("modifyMessage", uploadService.modifyUpload(upload) == 1 ? "수정되었습니다." : "수정을 하지 못했습니다.");
  ...
  public String removeUpload(@RequestParam(value="uploadNo", required=false, defaultValue="0") int uploadNo
    ...
    redirectAttributes.addFlashAttribute("removeMessage", removeCount == 1 ? "삭제되었습니다." : "삭제를 하지 못했습니다.");
    return "redirect:/upload/list.do";
  }
