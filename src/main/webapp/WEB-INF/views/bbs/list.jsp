...
<script>
  ...
  const fnInsertBbsMessage = () => {
    const insertBbsMessage = '${insertBbsMessage}';
    if(insertBbsMessage !== '') {
      alert(insertBbsMessage);
    }
  }
  
  const fnInsertReplyMessage = () => {
    const insertReplyMessage = '${insertReplyMessage}';
    if(insertReplyMessage !== '') {
      alert(insertReplyMessage);
    }
  }
  
  const fnRemoveMessage = () => {
