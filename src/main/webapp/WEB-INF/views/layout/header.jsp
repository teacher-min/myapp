...
<!-- include moment.js -->
<script src="${contextPath}/static/moment/moment-with-locales.min.js"></script>

<!-- include summernote css/js -->
<link rel="stylesheet" href="${contextPath}/static/summernote-0.8.18-dist/summernote.min.css">
<script src="${contextPath}/static/summernote-0.8.18-dist/summernote.min.js"></script>
<script src="${contextPath}/static/summernote-0.8.18-dist/lang/summernote-ko-KR.min.js"></script>

<!-- include custom css/js -->
<link rel="stylesheet" href="${contextPath}/static/css/init.css?dt=${dt}">
<link rel="stylesheet" href="${contextPath}/static/css/header.css?dt=${dt}">
